...
cell_rec <- 
 ...
 step_BoxCox(perim_ch_1, id = "box-cox") %>% 
 prep()
...
Left: a histogram of the cell perimeter predictor. Right: the same data after a Box–Cox transformation with $\lambda$ estimated to be −1.1

```{r chapter-03-fig-03}
tidy(cell_rec, id = "box-cox")
...
log_plot <- 
 ...
 geom_point() +
 scale_color_manual(values = c("\"Outliers\"" = "red", "Data Mainstream" = rgb(0, 0, 0, .1)))
...
A plot of the first three principal components for the cell segmenta- tion data, colored by cell type

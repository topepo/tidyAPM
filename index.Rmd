...
Each chapter in _APM_ has a computing section that describes in detail how the analyses in that chapter were conducted. This website aims to be an update to those computing sections that show how to conduct the same analses with witdymodels. 

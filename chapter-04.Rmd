...
```{r chapter-04-bayes, warning = FALSE, cache = TRUE}
library(tidyposterior)
accuracy_model <- perf_mod(accuracy_stats, seed = 406, iter = 5000, refresh = 0)
```
...
accuracy_diff <- 
  contrast_models(accuracy_model, list_1 = "svm", list_2 = "logistic", seed = 407)

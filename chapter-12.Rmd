...
```
The results show that using all of the predictors in the model has a significant negative effect on the model. Note that there are no standard errors associated with the results. This is a consqeuence of the validation set being a single resample. 
...
Similarly, the plsmod package contains the model definitions for the PLS discriminant analysis. Here, the number of PLS components is tuned. 
